...
def process_feedback_event(event: Dict[str, Any]):
    """Core business logic for feedback event."""
    ...
    UserProfileVectorManager.apply_feedback(user_id, content_vec, feedback_type)
